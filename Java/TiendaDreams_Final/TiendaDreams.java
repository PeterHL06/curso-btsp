...
public class TiendaDreams {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("5. Mostrar ventas de un cliente");
    ...
    private static void mostrarVentasCliente() {
        if (clientes.isEmpty()) {
        ...
        if (cliente.getVentas().isEmpty()) {
            System.out.println("⚠️ El cliente no tiene ventas registradas.");
        } else {
            System.out.println("\n--- Ventas de " + cliente.getNombre() + " ---");
